...
correctUsername = "enter the login name of your choice"
correctPassword = "enter a password tht you like to use"
#########################################################
...
def registerMFA():      
   ...
   auth_str=t.provisioning_uri(name='MG@AppliedComputerSecurity', issuer_name='AppliedComputerSecurity')
